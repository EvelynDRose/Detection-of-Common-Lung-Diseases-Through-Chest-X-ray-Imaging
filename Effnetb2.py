...
class EffNet(nn.Module):
    def __init__(self, num_classes=16):
        ...
        self.efficientnet = efficientnet_b2()
...
for epoch in range(EPOCHS):
    ...
    acuuracys.append(correct/(len(test_loader)))
...
torch.save(model.state_dict(), "DeepLearning/models/effnet.pt")

print(train_loss)
print(val_loss)

plt.title("EfficientNet2B Loss")
plt.xlabel("Epochs")
